...
<div class="content-block">
	<div class="container">
		...
		<div class="specialists">
			<!--<h3 class="specialists__title title"><?php post_type_archive_title(); ?></h3>-->
			<h3 class="specialists__title title">Специалисты на Химиков, 34</h3>
		...
		<!--МАЛУНЦЕВА-->
		<div class="specialists" style="padding-top:0">
			<!--<h3 class="specialists__title title"><?php post_type_archive_title(); ?></h3>-->
			<h3 class="specialists__title title">Специалисты на Малунцева, 25</h3>
			<div class="doctors__block specialists__block">				
