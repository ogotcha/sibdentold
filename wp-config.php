...
define( 'WPCACHEHOME', '/home/s/stasklmg/sd.stasklmg.beget.tech/public_html/wp-content/plugins/wp-super-cache/' );
define( 'DB_NAME', 'stasklmg_sibdent' );

/** MySQL database username */
define( 'DB_USER', 'stasklmg_sibdent' );

/** MySQL database password */
define( 'DB_PASSWORD', '1aFnHnrbg3' );
